...
function Features() {
  return (
    <div>
        <h1 className='text-4xl text-center font-bold mb-12 mt-12 text-yellow-400'>Key features of IQSchool Training</h1>
        <div className="container mx-auto p-4">
            <div className="grid grid-cols-3 gap-4">
                {/* Leftmost Grid */}
                <div className="col-span-1 p-4 shadow-lg rounded-lg text-center bg-gradient-to-r from-blue-500 to-purple-500 text-white">
            ...
            <div className="grid grid-cols-3 gap-4 mt-4">
                ...
                <p className="font-bold">We have structured Curriculum for all.</p>
                </div>

                {/* Right Grid */}
                <div className="col-span-1 p-4 shadow-lg rounded-lg text-center bg-gradient-to-r from-blue-500 to-purple-500 text-white">
                <p className="font-bold text-2xl">Placement Support</p>
                <p className="font-bold">Resume building, Mock interview sessions.</p>
                </div>
            </div>
        </div>
    </div>
